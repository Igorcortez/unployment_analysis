...
sphinx-apidoc -f -e -o docs/source/apidoc/ unployment_analysis/
...
sed -i '0,/unployment_analysis/s//API/' docs/source/apidoc/modules.rst
# Show package's name in the home page
sed -i '0,/project/s//unployment_analysis/' docs/source/index.rst
# Generate html docs
make -C docs/ html
