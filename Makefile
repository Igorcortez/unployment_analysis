IMAGE = unployment_analysis
PACKAGE = unployment_analysis
...
help:
	...
	@echo "    PARAMS             Parameters to pass as: $ unployment_analysis <command> $(PARAMS)."
...
clean: clean-dist
	rm -rf unployment_analysis.egg_info
